...
interface CycleFButtonProps {
  isOpen: boolean;
  onToggle: () => void;
  onScheduleSelect?: (year: number, period: string, cellNumber: number) => void;
}

export default function CycleFButton({ isOpen, onToggle, onScheduleSelect }: CycleFButtonProps) {
  ...
  // Perioadele și numerele celulelor pentru fiecare an
  const periods = [
    { text: 'Orar Semestrul de toamnă', cellNumbers: [1, 2, 3, 4], periodKey: 'semester1' },
    { text: 'Orar evaluarea periodică nr. 1', cellNumbers: [5, 6, 7, 8], periodKey: 'assessments1' },
    { text: 'Orar evaluarea periodică nr. 2', cellNumbers: [9, 10, 11, 12], periodKey: 'assessments2' },
    { text: 'Orar Sesiunea de examinare', cellNumbers: [13, 14, 15, 16], periodKey: 'exams' },
    { text: 'Orar Semestrul de primavara', cellNumbers: [17, 18, 19, 20], periodKey: 'semester2' },
  ];
